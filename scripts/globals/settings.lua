...
GIL_RATE   = 100.000; -- Multiplies gil earned from quests.  Won't always display in game.
EXP_RATE   = 100.000; -- Multiplies exp earned from fov.
TABS_RATE  = 100.000; -- Multiplies tabs earned from fov.
...
HARVESTING_RATE         = 1.0; -- % chance to recieve an item from haresting.  Set between 0 and 1.
EXCAVATION_RATE         = 1.0; -- % chance to recieve an item from excavation.  Set between 0 and 1.
LOGGING_RATE            = 1.0; -- % chance to recieve an item from logging.  Set between 0 and 1.
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 50;   -- cost of the timeless hourglass for Dynamis.
     CURRENCY_EXCHANGE_RATE = 198;      -- X Tier 1 ancient currency -> 1 Tier 2, and so on.  Certain values may conflict with shop items.  Not designed to exceed 198.
RELIC_2ND_UPGRADE_WAIT_TIME = 60;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
RELIC_3RD_UPGRADE_WAIT_TIME = 60;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
RIVERNE_PORTERS = 12000; -- Time in seconds that Unstable Displacements in Cape Riverne stay open after trading a scale.
LANTERNS_STAY_LIT = 120000; -- time in seconds that lanterns in the Den of Rancor stay lit.
